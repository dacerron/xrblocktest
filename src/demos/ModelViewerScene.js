/**
 * Ported from the XR Blocks ModelViewer sample (same scene graph & asset URLs).
 * Upstream: https://github.com/google/xrblocks/tree/main/samples/modelviewer
 * Docs: https://xrblocks.github.io/docs/samples/ModelViewer/
 */
